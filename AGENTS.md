...
- `prompt.txt` defines the grounding-prompt contract and is read at runtime. A downloaded app seeds and prefers `~/Library/Application Support/Presence/prompt.txt` and `quotes.csv`.
